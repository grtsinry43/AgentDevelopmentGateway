<script lang="ts">
	...
	const paths: Record<IconName, string[]> = {
		...
		settings: [
			'M8 10.5A2.5 2.5 0 1 0 8 5a2.5 2.5 0 0 0 0 5.5Z',
			'M6.75 2.5h2.5l.4 1.35 1.25.7 1.35-.35 1.25 2.15-.95 1 .05 1.45.95 1-1.25 2.15-1.35-.35-1.25.7-.4 1.35h-2.5l-.4-1.35-1.25-.7-1.35.35L2.5 9.75l.95-1-.05-1.45-.95-1L3.7 4.2l1.35.35 1.25-.7z'
		],
		command: [
