<script lang="ts">
	...
	const paths: Record<IconName, string[]> = {
		...
		scissors: [
			'M6 4.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z',
			'M6 14.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z',
			'M13.5 7.5 6.8 11',
			'M13.5 8.5 6.8 12'
		],
		clipboard: [
			'M5.5 3.5h1V2.75a.75.75 0 0 1 .75-.75h1.5a.75.75 0 0 1 .75.75V3.5h2a.75.75 0 0 1 .75.75V5h-7V4.25a.75.75 0 0 1 .75-.75Z',
			'M5 5h6v1.5a.75.75 0 0 1-.75.75h-4.5A.75.75 0 0 1 5 6.5z',
			'M5.5 9.5h5',
			'M5.5 11.5h3.5'
		],
		link: [
		...
		activity: ['M1.5 7.5h2.6l1.4-3.8 2.6 7 1.4-3.2h3'],
		stop: ['M4.5 4.5h7v7h-7z'],
		undo: ['M6.5 3 3 6.5 6.5 10', 'M4.5 6.5H10a3 3 0 0 1 0 6H7.5'],
		eye: [
